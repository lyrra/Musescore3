...
void init_scoreFonts() {
      /*
      not_initialized = 1;
      //_scoreFonts = new QVector<ScoreFont*>();
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Leland",     "Leland",      ":/fonts/leland/",    "Leland.otf"));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Bravura",    "Bravura",     ":/fonts/bravura/",   "Bravura.otf"  ));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Emmentaler", "MScore",      ":/fonts/mscore/",    "mscore.ttf"   ));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Gonville",   "Gootville",   ":/fonts/gootville/", "Gootville.otf"));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("MuseJazz",   "MuseJazz",    ":/fonts/musejazz/",  "MuseJazz.otf" ));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Petaluma",   "Petaluma",    ":/fonts/petaluma/",  "Petaluma.otf" ));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Finale Maestro", "Finale Maestro", ":/fonts/finalemaestro/", "FinaleMaestro.otf"));
      ScoreFont::_builtinScoreFonts.append(new ScoreFont("Finale Broadway", "Finale Broadway", ":/fonts/finalebroadway/", "FinaleBroadway.otf"));
      */
      }
